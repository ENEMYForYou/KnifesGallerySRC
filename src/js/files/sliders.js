			...
			*/
			on: {
				init: function (swiper) {
					...
					const allSlidesSum = document.querySelectorAll('.slide-main-block:not(.swiper-slide-duplicate)');
					allSlides.innerHTML = allSlidesSum.length < 10 ? `0${allSlidesSum.length}` : allSlidesSum.length;
				},
