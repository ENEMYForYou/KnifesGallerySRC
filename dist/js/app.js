(() => {
  ...
  (() => {
    ...
    function vt(e, t) {
        ...
        y = {
          ...
          show: function () {
            ...
            var e = y.state.isVisible,
              ...
              i = _e(y.props.duration, 0, rt.duration);
            if (e || t || s || n) return;
          ...
          hide: function () {
            ...
            var e = !y.state.isVisible,
              t = y.state.isDestroyed,
              s = !y.state.isEnabled,
              n = _e(y.props.duration, 1, rt.duration);
            if (e || t || s) return;
      ...
      function M(e) {
        return (y.state.isMounted && !y.state.isVisible) ||
          ...
          (r && "focus" === r.type)
          ? 0
          : _e(y.props.delay, e ? 0 : 1, rt.delay);
      }
      function $(e) {
        void 0 === e && (e = !1),
    ...
    Object.keys($t).forEach((e) => {
      Object.defineProperty(Pt.fn, e, { value: $t[e], writable: !0 });
    });
    const _t = Pt;
    function Dt(e, t) {
        ...
        (t.clickedSlide = n),
          t.virtual && t.params.virtual.enabled
            ? (t.clickedIndex = parseInt(
                _t(n).attr("data-swiper-slide-index"),
                10
              ))
            : (t.clickedIndex = i),
    ...
    const Jt = {
      loopCreate: function () {
        const e = this,
          ...
          i = n.children().length > 0 ? _t(n.children()[0].parentNode) : n;
        ...
        for (let e = 0; e < o.length; e += 1)
          i.append(_t(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
        for (let e = a.length - 1; e >= 0; e -= 1)
          i.prepend(_t(a[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      },
      loopFix: function () {
        const e = this;
    ...
    function es(e) {
      ...
      if (
        ...
        c.is(i.focusableElements) &&
          ...
          s.activeElement &&
            _t(s.activeElement).is(i.focusableElements) &&
            s.activeElement !== c[0] &&
    ...
    function ts(e) {
      ...
      if (!s.allowTouchMove)
        return (
          _t(l.target).is(n.focusableElements) || (s.allowClick = !1),
          void (
            n.isTouched &&
            (Object.assign(r, {
              startX: d,
      ...
      if (
        ...
        _t(l.target).is(n.focusableElements)
      )
    ...
    const ms = {
        ...
        images: {
          loadImage: function (e, t, s, n, i, r) {
            ...
            _t(e).parent("picture")[0] || (e.complete && i)
              ? l()
              : t
              ? ((o = new a.Image()),
                (o.onload = l),
      ...
      mount(e) {
        ...
        let i = (() => {
          if (e && e.shadowRoot && e.shadowRoot.querySelector) {
            const t = _t(e.shadowRoot.querySelector(n()));
      ...
      s({
        ...
        n("click", (e, s) => {
          const { $nextEl: n, $prevEl: r } = t.navigation,
            a = s.target;
          if (t.params.navigation.hideOnClick && !_t(a).is(r) && !_t(a).is(n)) {
            if (
              t.pagination &&
              t.params.pagination &&
      ...
      n("init", () => {
        ...
        n("click", (e, s) => {
          ...
          if (
            ...
            r.length > 0 &&
            !_t(n).hasClass(t.params.pagination.bulletClass)
          ) {
            if (
              t.navigation &&
    ...
    function Ts(e) {
      ...
      function a() {
        ...
        const s = e.clickedIndex,
          n = e.clickedSlide;
        if (n && _t(n).hasClass(t.params.thumbs.slideThumbActiveClass)) return;
        if (null == s) return;
        let i;
        if (
          ((i = e.params.loop
        ...
        if (
          ...
          document.querySelector(".main-block__slider") &&
            new bs(".main-block__slider", {
              ...
              parallax: !0,
              loop: !0,
              pagination: { el: ".control-main-block__dots", clickable: !0 },
              on: {
                init: function (e) {
